...
public class SchedulerSJF extends SchedulerBase implements Scheduler {
    Comparator<Process> burstComparator = Comparator.comparing(Process::getBurstTime);
    private PriorityQueue<Process> queue = new PriorityQueue<Process>(burstComparator);
    Logger myLogger;

    public SchedulerSJF (Logger myLogger){
